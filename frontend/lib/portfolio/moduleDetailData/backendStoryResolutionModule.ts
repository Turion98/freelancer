...
export const backendStoryResolutionModule: ModuleDetailData = {
  ...
  description:
    "Message flow across frontend, API, resolver, and story file during page delivery.",
  data: {
    columns: [
      { id: "user", label: "User" },
      { id: "frontend", label: "Frontend Runtime" },
      { id: "api", label: "Page API" },
      { id: "resolver", label: "Story Resolver" },
      { id: "file", label: "Story File" },
    ],
    rows: [
      { id: "step-1" },
      { id: "step-2" },
    ...
    items: [
      {
        ...
        detail: "User starts the interactive flow in the frontend runtime",
      },
      {
        id: "step-2",
        row: "step-2",
        ...
        variant: "forward",
        stepNumber: 2,
        label: "Request start page",
        detail: "GET /page/start?src=storyId",
      },
      {
        id: "step-3",
        row: "step-3",
        ...
        detail: "API delegates page lookup to the story resolver",
      },
      {
        id: "step-4",
        row: "step-4",
        ...
        variant: "forward",
        stepNumber: 4,
        label: "Load story JSON",
        detail: "Resolver opens the story source and inspects its structure",
      },
      {
        id: "step-5",
        row: "step-5",
        ...
        detail: "Structured story content is returned to the resolver",
      },
      {
        id: "step-6",
        row: "step-6",
        ...
        variant: "backward",
        stepNumber: 6,
        label: "Return normalized page object",
        detail: "Resolver extracts the requested page and normalizes its shape",
      },
      {
        id: "step-7",
        row: "step-7",
        ...
        detail: "API sends a stable page contract back to the frontend runtime",
      },
      {
        id: "step-8",
        row: "step-8",
        ...
        detail: "Frontend displays the resolved page to the user",
      },
    ],
  },
},
